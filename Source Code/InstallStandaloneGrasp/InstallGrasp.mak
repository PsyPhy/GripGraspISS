...
EXECUTABLES = ..\$(BUILDCONFIGURATION)\GraspHardwareStatus.exe ..\$(BUILDCONFIGURATION)\GraspTrackerDaemon.exe ..\$(BUILDCONFIGURATION)\PsyPhyOculusDemo.exe ..\$(BUILDCONFIGURATION)\OculusMouse.exe ..\$(BUILDCONFIGURATION)\GraspScreenshots.exe ..\$(BUILDCONFIGURATION)\Grasp.exe ..\Grasp\Grasp.bat ..\$(BUILDCONFIGURATION)\AlignToRigidBodyGUI.exe ..\$(BUILDCONFIGURATION)\GraspGUI.exe  ..\$(BUILDCONFIGURATION)\TaskProcessUnitTester.exe  ..\$(BUILDCONFIGURATION)\CreateRigidBodyModelFile.exe
