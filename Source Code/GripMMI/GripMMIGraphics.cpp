...
void GripMMIDesktop::InitializeGraphics( void ) {
	...
	DisplayErase( stripchart_display );
...
void GripMMIDesktop::AdjustScrollSpan( void ) {
	...
	if ( bottom >= (int) floor( max ) ) bottom = (int) floor( max );
...
void GripMMIDesktop::KillGraphics( void ) {
	...
	DisplayClose( cop_display );
	DisplayClose( xy_display );
	DisplayClose( zy_display );
	DisplayClose( stripchart_display );
