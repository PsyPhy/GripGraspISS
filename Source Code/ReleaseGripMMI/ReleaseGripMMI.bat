...
%TAR% --append %VERBOSE% --file=%ARCHIVE% "GripMMIDocumentation\GripMMI Runtime Installation Instructions.txt"
%TAR% --append %VERBOSE% --file=%ARCHIVE% "GripMMIDocumentation\GripMMI Release Notes.rtf"
