...
REM ***                                                                                   ***
REM *****************************************************************************************
"..\GraspExecutables\CreateRigidBodyModelFile.exe" %TRACKER% --unit=%UNIT% 0 1 2 3 4 5 6 7 > %DEST%\Hand.bdy
...
REM ***                                                                                   ***
REM *****************************************************************************************
"..\GraspExecutables\CreateRigidBodyModelFile.exe" %TRACKER% --unit=%UNIT% 0 1 2 3 4 5 6 7 > %DEST%\HMD.bdy
